      ...
      >
        ...
        <div className="flex min-h-[74px] items-center gap-3 rounded-[12px] bg-white px-4 py-3 text-black shadow-[0_16px_40px_rgba(0,0,0,0.12)]">
          <input
            ...
            className="min-w-0 flex-1 bg-transparent text-[12px] font-normal leading-[1.35] tracking-[-0.02em] text-black outline-none placeholder:text-black/55 sm:text-[16px]"
