  ...
  return (
    <div className="mx-auto w-full max-w-[760px]">
      ...
      >
        ...
        <div className="flex min-h-[42px] items-center gap-2 rounded-[12px] bg-white px-3 py-1 text-black shadow-[0_16px_40px_rgba(0,0,0,0.12)] min-[380px]:min-h-[46px] min-[380px]:gap-3 min-[380px]:px-4 sm:min-h-[62px] sm:py-2">
          <input
          ...
          <button
            ...
            className="grid size-7 shrink-0 place-items-center rounded-full bg-black text-white transition-colors hover:bg-black/82 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black/40 min-[380px]:size-8 sm:size-10"
